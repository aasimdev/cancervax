<?php
$GLOBALS['title'] = "Legendary Scientist and Biotech Veteran Joins CancerVax as Strategic Advisor - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
<section class="news-detail">
    <div class="container">
        <div class="post-title">
            <h1>Legendary Scientist and Biotech Veteran Joins CancerVax as Strategic Advisor</h1>
        </div>
