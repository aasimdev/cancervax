<?php
$GLOBALS['title'] = "CancerVax Announces Successful Tests of its Smart mRNA Technology - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
...
<li>Confirm that Smart mRNA will be turned off in non-cancerous cells with the corresponding genetic signature</li>
        ...
        <ul class="theme-list mb-4">
            <li>When GFP Smart mRNAs were delivered into a non-cancerous cell line (HEK293), without any artificial genetic signatures, they were turned off naturally in statistically significant amounts. This confirms that Smart mRNA can detect and avoid healthy cells!
            </li>
        </ul>

        <img src="./assets/img/gfp-smart-mrnas.png" alt="gfp-smart-mrnas" class="my-4 w-75 d-block mx-auto">
