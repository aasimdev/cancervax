<section class="marketbanner immTitle" style="background-image: url(./assets/images/immunotherapy-bg.jpg);">
    <div class="container">
        <h1>Immunotherapy</h1>
    </div>
</section>
...
<section class="mcta pt-0">
    <div class="container">
        <div class="mcta-bg" style="background: url(./assets/images/imm-cta.jpg) no-repeat center / cover">
            <div class="mcta-text">
