                ...
                <a href="https://www.youtube.com/watch?v=PXBNJe3nHp0" class="home-aug-28-c-short-video-card relative popup-youtube">
                    <div class="relative rounded-[26px] bg-transparent p-[2px]">
                        <div class="rounded-[24px] bg-transparent p-3 sm:p-4">
                            <div class="relative flex aspect-[4/3] flex-col items-center justify-start overflow-hidden rounded-[18px] p-4" style="background-image: url('<?php echo $full_url; ?>assets/images/cancervax-dna-background-with-red-play.png'); background-size: cover; background-position: center;">
        ...
        <div class="relative max-w-[1600px] mx-auto">
            <div class="relative">
                ...
                <a href="/single-news.php?id=52" class="home-aug-28-c-short-video-card relative">
                    <div class="relative rounded-[26px] bg-transparent p-[2px]">
                        <div class="rounded-[24px] bg-white p-3 sm:p-4">
                            <div class="relative flex aspect-[4/3] flex-col items-center justify-start overflow-hidden rounded-[18px] p-4" style="background-color: #1d8f97;">
                                <div class="home-aug-28-c-card-label-wrap">
                                ...
                                <div class="flex min-h-0 w-full flex-1 items-center justify-center">
                                    <div class="home-aug-29-mobile-card-copy w-full text-center text-white" style="font-family: 'Public Sans', sans-serif; font-size: clamp(0.9rem, 1.35vw, 1.15rem); font-weight: 600; line-height: 1.25; transform: translateY(-20px);">
