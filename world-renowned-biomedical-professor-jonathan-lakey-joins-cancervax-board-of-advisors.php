<?php
$GLOBALS['title'] = "World Renowned Biomedical Professor Jonathan Lakey Joins CancerVax Board of Advisors - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
...
<section class="news-detail">
    <div class="container">
        <div class="post-title">
            <h1>World Renowned Biomedical Professor Jonathan Lakey Joins Cancervax Board of Advisors</h1>
        </div>
        <h3>Dr. Lakey has been recognized nationally and internationally for his groundbreaking research in cell and tissue transplantation for patients suffering from diabetes and cancer </h3>
        <p>Lehi, UT – July 25, 2023 – Cancervax, Inc., a pre-clinical biotechnology company creating a better way to treat cancer, the developer of a breakthrough universal cancer treatment that will use the body’s immune system to treat cancer, reported that the Company has appointed Dr. Jonathan Lakey to Cancervax Board of Advisors.  </p>
        ...
        <p>Cancervax CEO Ryan Davies said, “We are honored to have Dr. Lakey join our Board of Advisors.  His decades of experience will help us better understand new ideas in oncology immunotherapy as we work on developing new cancer drugs”.</p>
