<?php
$GLOBALS['title'] = "CNN Reports Rise Of Cancer In Women - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="inPost-box">
                    <h1>CNN Reports Rise Of Cancer In Women</h1>
                    <div class="inPost-img">
                        <img src="./assets/img/inpost-18.png" alt="invest post">
                    </div>
                    <div class="inPost-description">
                        <p><a href="https://www.cnn.com/2023/08/16/health/early-onset-cancer-increase/index.html" target="_blank" rel="noopener noreferrer">https://www.cnn.com/2023/08/16/health/early-onset-cancer-increase/index.html</a></p>
                        <p><br></p>
                        <p>CNN warned women about a <strong><span>rise in cancer diagnosis</span></strong> in a recent article.</p>
                        <p>A government-funded study of 17 National Cancer Institute registries, published Wednesday in the journal JAMA Network Open, looked at more than 500,000 cases of early-onset cancer, or cancers diagnosed in patients under age 50, between 2010 and 2019.</p>
                        <p>This study found a<strong><span>&nbsp;troubling increase in cancer in women.</span></strong></p>
