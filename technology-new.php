<?php
$GLOBALS['title'] = "Technology New - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>

<section class="techBanner">
    <div class="container">
        <div class="techBanner-text">
            <h1>Technology</h1>
        </div>
...
<section class="cancer-treatment">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="ct-img">
                    <img src="./assets/img/ct-item.png" alt="ct-item.png">
                </div>
            </div>
            <div class="col-lg-7">
...
<section class="treatment">
    <div class="container">
        ...
        <div class="treatment-item">
            <h4>Cancer Cell <span>Detection​</span></h4>
            <img src="./assets/img/treatment1.png" alt="treatment">
        </div>
        <div class="treatment-item">
            <h4>Cancer Cell <span>Marking</span>​​</h4>
            <img src="./assets/img/treatment2.png" alt="treatment">
        </div>
        <div class="treatment-item">
            <h4>Cancer Cell <span>Killing​</span>​</h4>
            <img src="./assets/img/treatment3.png" alt="treatment">
        </div>
    </div>
</section>
...
<section class="remission">
    <div class="container">
        ...
        <p>The weakness in other immunotherapies is the inability to induce a strong and lasting immune response. By tricking the body into mounting a strong response to measles, we believe the immune system will naturally “learn” what cancer looks like and will continue the fight against that cancer on its own. The new memory T-cells and B-cells can protect the body from future recurrences of the cancer, just like it does with measles.</p>
        <p>We intend to prove this out in our pre-clinical research programs.</p>
    </div>
</section>



<section class="reducing-toxicity">
    <div class="container">
        <h3 class="d-sm-block d-none">Reducing Liver and Healthy Tissue Toxicity</h3>
        <h3 class="d-sm-none d-block">Potential Long-Term Remission</h3>
        <div class="row flex-lg-row flex-column-reverse">
            <div class="col-lg-6 text-center">
                <img src="./assets/img/reducing-toxicity.png" alt="reducing-toxicity">
            </div>
            <div class="col-lg-6">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 text-center">
                <div class="cold-tumors-img ">
                    <img src="./assets/img/cold-tumor.png" alt="cold-tumor">
                </div>
            </div>
        </div>
        <h3>Cancers can escape immune detection, but measles get caught. <span>That’s the trick we use!</span></h3>
    </div>
