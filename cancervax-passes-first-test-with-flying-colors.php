<?php
$GLOBALS['title'] = "CancerVax Passes First Test with Flying Colors - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
...
<section class="news-detail">
    <div class="container">
        <div class="post-title">
            <h1>CancerVax Passes First Test with Flying Colors</h1>
        </div>

        <h3>Recent in-vitro lab results confirm that the Company’s Smart mRNA can be used as a potential on/off switch for selectively detecting cancer cells</h3>
        <p>Lehi, Utah – December 20, 2024 – CancerVax, Inc., the developer of a breakthrough universal cancer treatment (UCT) platform that will use the body’s immune system to fight cancer, today announced the successful functional validation of its innovative Smart mRNA (messenger RNA) technology in lab tests.  </p>
        ...
        <ul class="theme-list mb-4">
            <li>Demonstrate the successful incorporation of our Smart mRNA payload into Flashpoint SNAs</li>
