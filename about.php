                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 col-md-8 col-xl-6">
                        <p>We started working with UCLA in early 2021 on a single-disease immunotherapy targeted at Ewing Sarcoma, a deadly children’s cancer. Existing immunotherapies target natural cancer cell markers, which unfortunately appear in health cells as well, resulting in the destruction of healthy cells and causing various levels of toxicity and side effects. <br><br>
                            ...
                            The UCV project progressed methodically with the development of various innovative technologies, including a foundational nanoparticle technology which can be programmed to target any cell and deliver any cargo.<br><br>
                            In a pivotal project meeting in the summer of 2023, the UCLA team reported positive progress on Ewing sarcoma and UCV.<br><br>
                            Surprisingly, the highly customizable low-cost nanoparticle technology developed for UCV can be adapted to perform an existing cancer immunotherapy (CAR-T Cell) at an extremely low cost. Thus, the Universal CAR-T Cell Platform was born.<br><br>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-9 col-md-8 col-xl-6">
                        <div class="process-description">
                            ...
                            <p>We are developing a disease-specific immunotherapy targeted at treating Ewing sarcoma, a rare but deadly bone and soft tissue cancer that primarily affects children and young adults. There is currently no FDA approved treatment for recurrence. The death rate is 100% of patients with recurrent Ewing sarcoma.
                                <br><br>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-9 col-md-8 col-xl-6">
                        <div class="process-description">
                            ...
                            <br><br>
                                CAR-T cell therapy is a type of FDA-approved immunotherapy in which a patient’s T-cells are genetically modified in the laboratory so they will bind to specific proteins (antigens) found on cancer cells and kill them. These modified T-cells are called Chimeric Antigen Receptor (CAR) T Cells. Conventional CAR-T Cell therapy can cost more than $500,000 per dose due to complicated and expensive lab processes. We believe we can dramatically lower the cost to a few hundred dollars per dose by simply helping the body make its own CAR T-cells.
                                <br><br>
