<?php
$GLOBALS['title'] = "CancerVax Lands Byron Elton - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
...
<section class="news-detail">
    <div class="container">
        <div class="post-title">
            <h1>Cancervax Lands Byron Elton</h1>
        </div>
        ...
        <p>LEHI, Utah, April 03, 2023 (GLOBE NEWSWIRE) -- Cancervax, Inc., a pre-clinical biotechnology company creating a better way to treat cancer, the developer of a breakthrough universal cancer treatment that will use the body’s immune system to treat cancer, today announced that Byron Elton has joined the Company’s management team and will serve as Chief Marketing Officer (CMO) and will help establish the Company as a significant force in the field of cancer research.</p>
