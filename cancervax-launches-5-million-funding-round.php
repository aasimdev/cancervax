...
<section class="news-detail">
    <div class="container">
        ...
        <p>Cancervax, Inc. is a pre-clinical biotechnology company developing a breakthrough universal cancer treatment to fight cancer using the body’s immune system. Working with a team of experienced cancer researchers and physicians at UCLA, we intend to create a Universal Cancer Treatment that will detect, mark, and destroy only the diseased cells with incredible precision. Like the COVID-19 vaccines that train the body to recognize and destroy the coronavirus, our cancer vaccine will leverage the body’s immune system to destroy cancer cells. As we develop our universal cancer treatment, we work with UCLA to develop single-disease cancer treatments targeting Ewing sarcoma, a rare but deadly bone and soft tissue cancer primarily affecting children and young adults. We look forward to the day when treating cancer will be as simple as getting a flu shot – a better way to treat cancer.  </p>
