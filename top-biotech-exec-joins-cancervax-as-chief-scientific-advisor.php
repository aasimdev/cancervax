<?php
$GLOBALS['title'] = "Top Biotech Exec Joins CancerVax as Chief Scientific Advisor - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
...
<section class="news-detail">
    <div class="container">
        ...
        <p>Dr. Ramachandra serves as a Director on the Board of Lyell Immunopharma (“Lyell”), following Lyell’s acquisition of ImmPACT Bio (“ImmPACT”) in October 2024. As CEO of ImmPACT from November 2021 until its acquisition, he led capital raises, secured clinical grants, and built a team that achieved FDA clearance for three Investigational New Drug (IND) applications, established manufacturing capabilities, and advanced multiple clinical studies.  </p>

        <p>In addition, Dr. Ramachandra currently serves as an advisor to private equity funds on companies in the pharmaceuticals, biotechnology, and medical devices/software sectors.  </p>

        <p>Previously, Dr. Ramachandra served as Chief Science, Technology, and Medical Officer at Baxter International, starting in June 2017. He was also appointed President of Baxter Pharmaceuticals in 2019. Prior to Baxter, he held the role of Senior Vice President, Head of Research & Development, at Pfizer Essential Health, and served as Chief Scientific Officer at Hospira from 2008 until Pfizer acquired Hospira in 2015. Earlier in his career, Dr. Ramachandra held senior roles at Pfizer and Merck & Co., specializing in oncology, global product development, medical affairs, business development, and clinical pharmacology. He began his medical career as an intern and resident physician at Massachusetts General Hospital, Harvard Medical School.</p>

        <p>Dr. Ramachandra earned his undergraduate degree in biochemistry, a PhD in experimental pathology (with a focus on chronic lymphocytic leukemia), and an MD from Rutgers University. He also holds an MBA from the Wharton School, University of Pennsylvania.</p>

        <p>In other news, the company recently moved its corporate headquarters to Lehi, Utah. The Wasatch Front has become a hotbed for tech companies and biotech startups and fosters a vibrant community of technology talent and investors.</p>

        <p>Dr. Ramachandra commented, “When I learned about CancerVax, my first thought was that making cancer cells look like measles or other immunized viral diseases to ‘trick’ the body’s natural immune system into killing these ‘disguised’ cancer cells is a very elegant solution. I also firmly believe that this type of revolutionary approach to cancer treatment must be vigorously pursued.”</p>

        <p>Dr. Ramachandra concluded, “I am very excited about the opportunity to work with the CancerVax team to help guide the Company through the preclinical development process.”</p>
