            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 justify-center">
                <div class="text-center w-auto mx-auto team-item">
                    ...
                    <div class="team-description hidden">
                        <img src="<?php echo  $full_url; ?>assets/images/george.png" alt="Team Image" class="max-w-[300px] mx-auto my-4 block rounded-[10px]">
        ...
        <div class="xl:max-w-[614px] mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center my-6">
                ...
                <div class="text-center w-auto mx-auto team-item">
                    ...
                    <div class="team-description hidden">
                        <img src="<?php echo  $full_url; ?>assets/images/lakey.png" alt="Team Image" class="max-w-[300px] mx-auto my-4 block rounded-[10px]">
                        <ul class="theme-list px-6 pb-6 [&>li]:text-black">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center my-6">
                ...
                <div class="text-center w-auto mx-auto team-item">
                    ...
                    <div class="team-description hidden">
                        <img src="<?php echo  $full_url; ?>assets/images/matthew-spear.png" alt="Team Image" class="max-w-[300px] mx-auto my-4 block rounded-[10px]">
                        <ul class="theme-list px-6 pb-6 [&>li]:text-black">
