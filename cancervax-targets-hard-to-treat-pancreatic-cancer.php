<?php
$GLOBALS['title'] = "CancerVax Targets Hard to Treat Pancreatic Cancer - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
...
<section class="news-detail">
    <div class="container">
        <div class="post-title">
            <h1>CancerVax Targets Hard to Treat Pancreatic Cancer </h1>
        </div>

        <h3>With limited options available to treat Pancreatic Ductal Adenocarcinoma (PDAC), the Company’s Universal Cancer Treatment Platform may provide hope for patients and doctors</h3>
        <p>Lehi, UT, December 11, 2024 (GLOBE NEWSWIRE) -- CancerVax, Inc., the developer of a breakthrough universal cancer treatment (UCT) platform that will use the body’s immune system to treat cancer, announced today that the Company has selected Pancreatic Ductal Adenocarcinoma (PDAC) as one of its first targets for preclinical development.   </p>

        <p>The <a href="https://www.cancer.org/cancer/types/pancreatic-cancer/about/key-statistics.html#:~:text=of%20pancreatic%20cancer-,How%20common%20is%20pancreatic%20cancer%3F,will%20die%20of%20pancreatic%20cancer." target="_blank" rel="noopener noreferrer">American Cancer</a> Society estimates that 66,440 people in the US will be diagnosed with pancreatic cancer in 2024 and 515,000 worldwide. Approximately 85% of all pancreatic cancer diagnoses are the PDAC cancer type. According to <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC7031151/" target="_blank" rel="noopener noreferrer">recent studies</a>, PDAC is “one of the most lethal diseases, with an average 5-year survival rate of less than 10%. This devasting outcome is mostly due to the fact that traditional treatments such as chemotherapy, surgery, and radiation have not been shown to significantly improve rate of survival.”  </p>

        <p>CancerVax’s novel UCT Platform is a customizable technology that can target many types of cancer. A single injection contains billions of CancerVax nanoparticles. Each nanoparticle is equipped with detectors to precisely detect cancer cells. First, the nanoparticles latch onto cells with surface proteins highly expressed on cancer cells. After entering the cell, the nanoparticles release a proprietary “Smart mRNA” payload. Only if the cell matches a cancer-specific genetic signature, not found in healthy cells, the Smart mRNA will then instruct the cancer cell to produce proteins associated with well immunized diseases such as measles. Our technology makes the cancer cells look like measles, enabling the immune system to selectively destroy the cancer cells.   </p>

        <p>Byron Elton, CEO of CancerVax said, “The body is very good at fighting well known diseases such as measles. In fact, after a measles infection or vaccination, the body will have lifelong immunity to measles through the natural memories of immune cells such as B-cells and T-cells.  These immune cells are constantly on the lookout for measles viruses and prevent infection. It is this strong existing immunity that we aim to leverage in the battle against cancer. Other cancer therapies, such as personalized cancer vaccines, try to teach the immune system what cancer looks like with limited success and are extremely expensive. Teaching the immune system is like teaching an old dog a new trick – very difficult to do. So instead, we’re going to trick the dog into performing something it knows how to do very well.  We believe our approach will make all the difference in using the body’s immune system to treat cancer.” </p>

        <p>Mr. Elton concluded, “Our goal is to increase our accuracy of detecting, marking and killing only cancer cells, and reducing very toxic off-target effect that other treatments such as chemo can have on the body.”</p>

        <p>Dr. Adam Grant, the Company’s Principal Scientist said, “When analyzing which cancer type we should attack first, we used sophisticated artificial intelligence tools to determine that PDAC cancer cells have high expressions of a surface protein that we can target, and known genetic signatures we can program into our Smart mRNA for precise detection. In addition, PDAC cells have many of the biological mechanisms in place to process our Smart mRNA. While PDAC cells are very good at hiding from the immune system, our theory is that by disguising them as measles, they are very likely to be detected by the natural immune system, which is highly effective at finding and killing measles. These factors combined with the limited treatment options for PDAC made our decision pretty clear.  We’re very excited about the potential to dramatically improve immunotherapy treatments for patients with this devastating disease.”</p>

        <p>Dr. George Katibah, the Company’s Chief Scientific Officer added, “Tumor immunotherapy has revolutionized cancer treatments. However, current therapies remain suboptimal for many types of tumors. New approaches to harness the immune system are needed in diseases like pancreatic cancer. CancerVax’s innovative way of using a highly functionalized nanoparticle to precisely detect cancer cells and redirect the immune system into attacking it, is a novel approach with exciting potential. I wake up every morning excited to go work. The global success of the mRNA-based COVID-19 vaccine gave us confidence in our Smart mRNA platform. Now, we are working with world-class partners to put these technologies together in a way that has never been done before. We look forward to progressing to animal studies to demonstrate safety and efficacy as soon as possible.”</p>
