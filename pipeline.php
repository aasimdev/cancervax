    ...
    <div class="container">
        ...
        <div class="pC-pipeline-item" id="uctcp">
            ...
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    <p class="ccart-text">Based on the foundational nanoparticle technology developed for UCV, we are developing a novel Universal CAR-T Cell therapy, to be delivered as a shot, that can reprogram natural immune T-cells inside the body to seek and destroy any targeted cancer cells.
                        <br><br>
                ...
                <div class="col-lg-5">
                    <div class="pC-pipeline-img">
                        <img src="./assets/img/u-cart-right.png" alt="pipeline-virus">
                    </div>
                </div>
            </div>
