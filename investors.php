...
<div class="offerScreen">
    <div class="mainParent">
        <!-- Section 1 -->
        <div class="heroSection" id="treat-cancer">
            <div class="container">
        ...
        <div class="nav-section">
            <div class="container">
                <div class="investor-navbar">
                    <a href="#treat-cancer">Overview</a>
                    <a href="#reason-to-invest">Reason to Invest</a>
                    <a href="#vaccine-platform">Vaccine Platform</a>
        ...
        <div class="all-section">
            <!-- 2nd Section -->
            <div class="investSection" id="reason-to-invest">
                <div class=" container">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6 first-desktop">
                            <div class="priceCardLeft">
                                ...
                                <div class="priceDetails">
                                    ...
                                    <div>
                                        ...
                                        <div class="cardActualBottom">See on SEC.gov</div>
                                    </div>
                                </div>
            ...
            <!-- 3rd Section -->
            <div class="problemSection" id='vaccine-platform'>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
            ...
            <!-- 4th Section -->
            <div class="investSection odp-main" id='development-pipeline'>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="offeringTitleTwoWrap">
                                ...
                                <div class="universal-heading d-flex align-items-center justify-content-lg-between flex-column flex-lg-row">
                                    ...
                                    <div class="learnMore mb-0 mt-3 mt-lg-0">
                                        <a href="#">Learn More</a>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-3 remove-t3">
                        <div class="col-lg-6">
                            <div class="pipeline-virus-left text-center">
                    ...
                    <div class="Children">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="learnMore first-mobile">
                                    <a href="#">Learn More</a>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="learnMore first-desktop">
                                    <a href="#">Learn More</a>
                                </div>
                    ...
                    <div class="priceDescriptionCard">
                        ...
                        <div class="billion-wrap">
                            <div class="billion-text">
                                <span>U.S. cancer healthcare spend in 2015</span>
                        ...
                        <div class="billion-wrap">
                            <div class="billion-text">
                                <span>Projected U.S. cancer healthcare spend by 2030</span>
                                <span class="small-number">(4)</span>
                            </div>
                        </div>
                        ...
                        <div class="billion-wrap">
                            <div class="billion-text">
                                <span>Projected global cancer drugs market by 2030</span>
                        ...
                        <div class="billion-wrap">
                            <div class="billion-text billion-text-last">
                                <span>Projected global biotechnology market by 2030</span>
            ...
            <!-- 5th Section -->
            <div class="priceDescription" id='why-invest'>
                <div class="container">
            ...
            <div class="termSection" id='terms'>
                <div class="container">
                    ...
                    <div class="term-card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="offer-price min-inv">$525</div>
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-2">
                                <div class="offerGreenSpaceOP">
                                    s
                                </div>
                    ...
                    <p> THESE OFFERING MATERIALS MAY CONTAIN FORWARD-LOOKING STATEMENTS AND INFORMATION RELATING TO, AMONG OTHER THINGS, THE COMPANY, ITS BUSINESS PLAN AND STRATEGY, AND ITS INDUSTRY. THESE FORWARDLOOKING STATEMENTS ARE BASED ON THE BELIEFS OF, ASSUMPTIONS MADE BY, AND INFORMATION CURRENTLY AVAILABLE TO THE COMPANY’S MANAGEMENT. WHEN USED IN THE OFFERING MATERIALS, THE WORDS
                        ...
                        STATEMENTS. INVESTORS ARE CAUTIONED NOT TO PLACE UNDUE RELIANCE ON THESE FORWARD-LOOKING STATEMENTS, WHICH SPEAK ONLY AS OF THE DATE ON WHICH THEY ARE MADE. THE COMPANY DOES NOT UNDERTAKE ANY OBLIGATION TO REVISE OR UPDATE THESE FORWARD-LOOKING STATEMENTS TO REFLECT EVENTS OR CIRCUMSTANCES AFTER SUCH DATE OR TO REFLECT THE OCCURRENCE OF UNANTICIPATED EVENTS.</p>
