...
<section class="news-detail">
    <div class="container">
        <div class="post-title">
            <h1>Cancervax Launched</h1>
        </div>
        <h3>The Company was founded by experienced healthcare executive Lindsay Mann</h3>
        <p>SANTA BARBARA, CA – March 23, 2021 – Cancervax, Inc., a developer of immunotherapy cancer treatments that use the body’s immune system to fight cancer, today announced the formation of the Company by Lindsay Mann, an experienced healthcare executive.</p>
        <p>“For decades, surgery, chemotherapy and radiation therapy have been the standards of care for cancer treatment, and often the only options,” said Lindsay Mann, CEO of Cancervax. “They operate on the basic premise that cancer cells are fast growing cells, so using powerful toxic chemicals (chemotherapy) or power x-rays (radiation) they hope to kill those cells to stop the cancer.”</p>
        <p>Mr. Mann continued, “The problem is that these treatments are not always very targeted, so they also kill normal fast-growing cells, such as hair cells, intestine cells, mouth-lining cells and others. This inadvertent side effect of killing healthy cells is what causes the debilitating side effects of chemotherapy and radiation, and a reduced quality of life for cancer patients.”</p>
